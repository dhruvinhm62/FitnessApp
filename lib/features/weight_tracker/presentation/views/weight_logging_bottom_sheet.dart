...
class WeightLoggingBottomSheet extends StatefulWidget {
  ...
  @override
  State<WeightLoggingBottomSheet> createState() => _WeightLoggingBottomSheetState();
}
...
class _WeightLoggingBottomSheetState extends State<WeightLoggingBottomSheet> {
  ...
  void initState() {
    super.initState();
    _textController = TextEditingController(text: controller.currentWeight.value.toString());
  }
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                final double? newWeight = double.tryParse(_textController.text);
                if (newWeight != null) {
                  ...
                  controller.logWeight(double.parse(finalWeight.toStringAsFixed(1)));
                  Get.back();
                } else {
                  Get.snackbar(
                    'Invalid Input',
